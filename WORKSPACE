...
##################################
# Prevent Bazel from trying to build rxjs
local_repository(
...
local_repository(
    ...
    path = "node_modules/@ngtools/webpack/node_modules/rxjs/src",
)

local_repository(
    name = "rxjs_ignore_nested_4",
    path = "node_modules/@schematics/update/node_modules/rxjs/src",
)

local_repository(
    name = "rxjs_ignore_nested_5",
    path = "node_modules/@angular-devkit/build-angular/node_modules/rxjs/src",
)
